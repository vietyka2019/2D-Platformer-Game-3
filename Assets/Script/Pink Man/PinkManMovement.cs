...
public class PinkManMovement : MonoBehaviour
{
    ...
    [SerializeField] GameObject destroyCharacterOnCollision; // prefab
    ...
    [SerializeField] enum MovementState { idle, run, jump, fall, doubleJump, hit, hitOnCollision };
    ...
    public void UpdateAnimation()
    {
        ...
        {
            state = MovementState.hit; // hit = fall
            Debug.Log((int)state); 
        }
